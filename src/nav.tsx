                ...
                <div className="menuNav">
                    <div className="menuHeader pb-20">
                        ...
                        <form className='flex sm:items-center gap-8 flex-col sm:flex-row' action="">
                            <input type="text" className={`bg-[#fafafa] sm:h-[4vh] h-[5vh] rounded-md text-[#131313] searchbar text-base sm:w-[290px] w-[250px] sm:px-2 px-4 placeholder-gray-400`} placeholder='What are you looking for ?' />
                            <button type='button'>
