...
export default function nav() {
    return (
        <motion.div
            ...
            className='menu'
        >
            <div className="body absolute bg-[#090909] top-[-60px] right-[-30px] h-[9999px] w-[500px] z-20 lg:hidden text-4xl pt-40 pl-16 menuBody">
                <div className="menuNav">
                    <div className="menuHeader pb-20">
                        ...
                        <form className='flex items-center gap-8' action="">
                            <input type="text" className={`bg-[#fafafa] h-[4vh] rounded-md text-[#131313] searchbar text-base w-[290px] px-2 placeholder-gray-400`} placeholder='What are you looking for ?' />
                            <button type='button'>
